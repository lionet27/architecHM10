...
public class Order {
    ...
    /**
     * Конструктор, инициализирующий пустой
     * список элементов заказа.
     */
    public Order() {
    ...
    /**
     * Геттер для получения списка элементов
     * заказа.
     *
    ...
    /**
     * Сеттер для установки списка элементов
     * заказа.
     *
    ...
    /**
     * Метод для добавления элемента заказа в
     * текущий заказ.
     *
     ...
     * учитывая цену и количество каждого
     * продукта.
     *
