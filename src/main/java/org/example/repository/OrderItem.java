...
public class OrderItem {
    ...
    // Продукт, на который ссылается данный
    // элемент заказа
    ...
    /**
     * Конструктор, создающий элемент заказа на
     * основе продукта и его количества.
     *
     * @param product  Продукт, который необходимо
     *                 добавить в заказ
    ...
    /**
     * Геттер для получения продукта, связанного
     * с данным элементом заказа.
     *
    ...
    /**
     * Сеттер для установки продукта для данного
     * элемента заказа.
     *
     * @param product Продукт, который необходимо
     *                связать с элементом заказа
     */
     ...
     * в данном элементе заказа.
     *
     * @return количество продукта в элементе
     *         заказа
     */
    ...
    /**
     * Сеттер для установки количества продукта
     * в элементе заказа.
     *
     * @param quantity Количество продукта, которое
